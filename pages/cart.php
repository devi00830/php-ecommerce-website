    ...
    <div class="container">
        ...
        if (empty($cart_items)) {
            ...
            foreach ($products as $product) {
                ...
                $serverPath = __DIR__ . '/../images/' . $filename;
                $webPath = '../images/' . $filename;
                $imgSrc = ($filename !== '' && file_exists($serverPath)) ? htmlspecialchars($webPath) : '../images/product.png';
                $productName = htmlspecialchars($product['name']);
                $productPrice = htmlspecialchars($product['price']);

                echo "<div class='cart-item'>
                        <img src='" . $imgSrc . "' alt='" . $productName . "' class='item-image'>
                        <div class='item-details'>
                            <div class='item-name'>" . $productName . "</div>
                            <div class='item-price'>\$" . $productPrice . " x $quantity</div>
                        </div>
